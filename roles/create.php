...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $stmt = $pdo->prepare("INSERT INTO RestaurantRoles (RestaurantID, RoleName, Permissions) VALUES (?, ?, ?)");
    $stmt->execute([$restaurantId, $roleName, $permJson]);
