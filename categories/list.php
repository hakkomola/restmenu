...
<div class="container mt-5">
    ...
    <a href="create.php" class="btn btn-success mb-3">Yeni Kategori Ekle</a>
    ...
    <table class="table table-bordered" id="category-table">
        ...
        <tbody id="sortable">
            ...
            <tr data-id="<?= $c['CategoryID'] ?>">
                ...
                <td>
                    <?php if ($c['ImageURL']): ?>
                        <img src="../<?= htmlspecialchars($c['ImageURL']) ?>" style="height:60px;">
                    <?php endif; ?>
                </td>
                <td>
                    <a href="edit.php?id=<?= $c['CategoryID'] ?>" class="btn btn-primary btn-sm">Düzenle</a>
                    <a href="delete.php?id=<?= $c['CategoryID'] ?>" class="btn btn-danger btn-sm" onclick="return confirm('Silmek istediğinize emin misiniz?')">Sil</a>
                </td>
            </tr>
            <?php endforeach; ?>
        </tbody>
