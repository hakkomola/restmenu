...
<section class="stats-section">
  <div class="container">
    <div class="row g-4 justify-content-center text-center">
      <div class="col-md-3 col-6"><div class="stat-card"><h2 class="count" data-target="125">0</h2><p>Aktif Kullanıcı</p></div></div>
      <div class="col-md-3 col-6"><div class="stat-card"><h2 class="count" data-target="87">0</h2><p>Restoran Kullanıyor</p></div></div>
      <div class="col-md-3 col-6"><div class="stat-card"><h2 class="count" data-target="642">0</h2><p>Menü Oluşturuldu</p></div></div>
      <div class="col-md-3 col-6"><div class="stat-card"><h2 class="count" data-target="12450">0</h2><p>Menü Görüntülendi</p></div></div>
    </div>
  </div>
</section>
